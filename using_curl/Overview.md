...
the cUrl parameters into similar other utilities that also can do HTTP POSTs of multipart/form-data.
...
[RenderPdfForm](./RenderPdfForm.md) - Render a PDF form using the AEM Forms Service.