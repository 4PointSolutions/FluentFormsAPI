...
@WireMockTest
class SpringRestClientRestClientTest {
	...
	void setup(WireMockRuntimeInfo wmRuntimeInfo) {
		...
		underTest = SpringRestClientRestClient.factory().apply(aemConfig, ENDPOINT, ()->CORRELATION_ID_TEXT);
	}
	...
	void testMultipleEndpoints() throws Exception {
		...
		var client1 = SpringRestClientRestClient.factory().apply(aemConfig, endPoint1, null);
		var client2 = SpringRestClientRestClient.factory().apply(aemConfig, endPoint2, ()->CORRELATION_ID_TEXT);
