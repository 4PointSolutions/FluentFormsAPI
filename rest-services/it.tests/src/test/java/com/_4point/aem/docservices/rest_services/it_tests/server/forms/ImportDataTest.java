...
class ImportDataTest {
	...
	private static final String IMPORT_DATA_URL = "http://" + AemInstance.AEM_1.aemHost() + ":" + AemInstance.AEM_1.aemPort() + TEST_MACHINE_AEM_TYPE.pathPrefix() + "/services/FormsService/ImportData";
