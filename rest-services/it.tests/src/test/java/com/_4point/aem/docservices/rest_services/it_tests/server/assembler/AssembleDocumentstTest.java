...
public class AssembleDocumentstTest {
	...
	private static final String ASSEMBLE_DOCUMENT_URL = "http://" + TEST_MACHINE_NAME + ":" + TEST_MACHINE_PORT_STR + ASSEMBLE_DOCUMENT_PATH;
	...
	void testAssembleDocuments_AllArgs() throws Exception {
		...
		try (final FormDataMultiPart multipart = new FormDataMultiPart()) {
			multipart.field(DATA_PARAM_NAME, SAMPLE_FORM_DDX, MediaType.APPLICATION_XML_TYPE)
