		...
		try {
			...
			try (Document result = docAssuranceService.secureDocument()
									...
									.setReOptions()
										...
										.setUsageRights()
											.transform(b->enabledBarcodeDecoding ? b : b.setEnabledBarcodeDecoding(enabledBarcodeDecoding.booleanValue()))
											.transform(b->enabledComments ? b : b.setEnabledComments(enabledComments.booleanValue()))
											.transform(b->enabledCommentsOnline ? b.setEnabledCommentsOnline(true) : b.setEnabledCommentsOnline(enabledBarcodeDecoding.booleanValue()))
											.transform(b->enabledDigitalSignatures ? b.setEnabledDigitalSignatures(true) : b.setEnabledDigitalSignatures(enabledDigitalSignatures.booleanValue()))
											.transform(b->enabledDynamicFormFields ? b.setEnabledDynamicFormFields(true) : b.setEnabledDynamicFormFields(enabledDynamicFormFields.booleanValue()))
											.transform(b->enabledDynamicFormPages ? b.setEnabledDynamicFormPages(true) : b.setEnabledDynamicFormPages(enabledDynamicFormPages.booleanValue()))
											.transform(b->enabledEmbeddedFiles ? b.setEnabledEmbeddedFiles(true) : b.setEnabledEmbeddedFiles(enabledEmbeddedFiles.booleanValue()))
											.transform(b->enabledFormDataImportExport ? b.setEnabledFormDataImportExport(true) : b.setEnabledFormDataImportExport(enabledFormDataImportExport.booleanValue()))
											.transform(b->enabledFormFillIn ? b.setEnabledFormFillIn(true) : b.setEnabledFormFillIn(enabledFormFillIn.booleanValue()))
											.transform(b->enabledOnlineForms ? b.setEnabledOnlineForms(true) : b.setEnabledOnlineForms(enabledOnlineForms.booleanValue()))
											.transform(b->enabledSubmitStandalone ? b.setEnabledSubmitStandalone(true) : b.setEnabledSubmitStandalone(enabledSubmitStandalone.booleanValue()))
											.done()
										.done()
									.done()
									.executeOn(inDoc)) {
